...
standard output functions for callbacks.  The included examples can also be
...
There are several example programs located in F<examples/>.  Refer to each
program's usage for more information.
