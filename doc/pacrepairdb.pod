...
Attempt to broken package entries in libalpm's database.  Any missing essential
files will be created and the packages will be reinstalled from the cache.
